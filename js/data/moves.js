exports.BattleMovedex = {
    ...
    airslash: {
        ...
        secondary: { chance: 25, volatileStatus: "flinch" },
        target: "any",
        type: "Flying",
        contestType: "Cool",
    ...
    allyswitch: {
        ...
        priority: 2,
        flags: { metronome: 1 },
        condition: { duration: 2, counterMax: 729 },
        target: "self",
        type: "Psychic",
        zMove: {
            boost: { spe: 2 }
    ...
    axekick: {
        ...
        pp: 10,
        priority: 0,
        flags: { contact: 1, protect: 1, mirror: 1, metronome: 1, striker: 1 },
        hasCrashDamage: true,
    ...
    barbbarrage: {
        ...
        target: "normal",
        type: "Poison",
        desc: "Hits three times. Has a 50% chance to poison the target. Power doubles if the target is already poisoned.",
        shortDesc: "Hits 3 times.50% psn. 2x power if target already poisoned."
    },
    barrage: {
        num: 140,
        accuracy: 95,
    ...
    chillingnibble: {
        ...
        type: "Ice",
        contestType: "Clever",
        desc: "Has a 100% chance to frostbite the foe.",
        shortDesc: "100% chance to frostbite the foe."
    },
    chillingwater: {
        num: 886,
        accuracy: 100,
    ...
    chillyreception: {
        ...
        weather: "snowscape",
        selfSwitch: true,
        condition: { duration: 1, onBeforeMovePriority: 100 },
        target: "all",
        type: "Ice",
    ...
    destinybond: {
        ...
        condition: { noCopy: true, onBeforeMovePriority: -1 },
        target: "self",
        type: "Ghost",
    ...
    disable: {
        ...
        condition: { duration: 5, noCopy: true, onResidualOrder: 17, onBeforeMovePriority: 7 },
        target: "normal",
        type: "Normal",
        zMove: { effect: "clearnegativeboost" },
        contestType: "Clever",
    ...
    explosion: {
        ...
        type: "Normal",
        contestType: "Beautiful",
        desc: "The user faints after using this move, even if this move fails for having no target. Halves the target's Defense during the damage calculation. This move is prevented from executing if any active Pokemon has the Damp Ability.",
        shortDesc: "The user faints. Halves Def."
    },
    extrasensory: {
        num: 326,
        accuracy: 95,
    ...
    furycutter: {
        ...
        type: "Bug",
        contestType: "Cool",
        desc: "Power doubles with each successful hit, up to a maximum of 320 power. The power is reset if this move misses or another move is used.",
        shortDesc: "Power doubles with each hit, up to 320."
    },
    furyswipes: {
        num: 154,
        accuracy: 80,
    ...
    highjumpkick: {
        ...
        pp: 10,
        priority: 0,
        flags: { contact: 1, protect: 1, mirror: 1, gravity: 1, metronome: 1, striker: 1 },
        hasCrashDamage: true,
        target: "normal",
        type: "Fighting",
        contestType: "Cool",
    ...
    lightscreen: {
        ...
        condition: { duration: 5, onSideResidualOrder: 26, onSideResidualSubOrder: 2 },
        target: "allySide",
        type: "Psychic",
        zMove: {
            boost: { spd: 1 }
    ...
    lockon: {
        ...
        priority: 0,
        flags: { protect: 1, mirror: 1, metronome: 1 },
        condition: { noCopy: true, duration: 2, onSourceInvulnerabilityPriority: 1 },
        target: "normal",
        type: "Normal",
        zMove: {
            boost: { spe: 1 }
    ...
    luckychant: {
        ...
        condition: { duration: 5, onCriticalHit: false, onSideResidualOrder: 26, onSideResidualSubOrder: 6 },
        target: "allySide",
        type: "Normal",
        zMove: {
            boost: { evasion: 1 }
    ...
    mist: {
        ...
        flags: { snatch: 1, metronome: 1 },
        sideCondition: "mist",
        condition: { duration: 5, onSideResidualOrder: 26, onSideResidualSubOrder: 4 },
        target: "allySide",
        type: "Ice",
        zMove: { effect: "heal" },
        contestType: "Beautiful",
    ...
    mistyexplosion: {
        ...
        target: "allAdjacent",
        type: "Fairy",
        desc: "If the current terrain is Misty Terrain and the user is grounded, this move's power is multiplied by 1.5.The user faints after using this move, even if this move fails for having no target. Halves the target's Special Defense during the damage calculation. This move is prevented from executing if any active Pokemon has the Damp Ability.",
        shortDesc: "User faints. Halves Sp.Def. User on Misty Terrain: 1.5x power."
    },
    mistyterrain: {
        num: 581,
        accuracy: true,
    ...
    mysticalpower: {
        ...
        target: "normal",
        type: "Psychic",
        desc: "Has a 15% chance to raise the user's Special Attack by 1 stage.",
    ...
    ragingbull: {
        ...
        target: "normal",
        type: "Normal",
        desc: "If this attack does not miss, the effects of Reflect, Light Screen, and Aurora Veil end for the target's side of the field before damage is calculated. If the user's current form is a Paldean Tauros or Granbull, this move's type changes to match. Fighting type for Combat Breed, Fire type for Blaze Breed, Water type for Aqua Breed and Fairy type for Granbull.",
    ...
    reflect: {
        ...
        condition: { duration: 5, onSideResidualOrder: 26, onSideResidualSubOrder: 1 },
        target: "allySide",
        type: "Psychic",
        zMove: {
            boost: { def: 1 }
    ...
    rototiller: {
        ...
        contestType: "Tough",
        desc: "Raises the Attack and Special Attack of all grounded Grass-type Pokemon on the field by 1 stage. If the terrain is Grassy Terrain, this move raises the Attack and Special Attack of all grounded Grass-type Pokemon on the field by 2 stages.",
    ...
    safeguard: {
        ...
        condition: { duration: 5, onSideResidualOrder: 26, onSideResidualSubOrder: 3 },
        target: "allySide",
        type: "Normal",
        zMove: {
            boost: { spe: 1 }
    ...
    sandsearstorm: {
        ...
        target: "allAdjacentFoes",
        type: "Ground",
        desc: "Has a 30% chance to burn the target. If the weather is Sandstorm, this move does not check accuracy. If this move is used against a Pokemon holding Utility Umbrella, this move's accuracy remains at 80%.",
        shortDesc: "30% chance to burn foe(s). Sandstorm: can't miss."
    },
    sandstorm: {
        num: 201,
        accuracy: true,
    ...
    skyattack: {
        ...
        type: "Flying",
        contestType: "Cool",
        desc: "Has a 30% chance to make the target flinch and cannot be selected the turn after it's used.",
        shortDesc: "30% flinch. Cannot be selected the turn after it's used."
    },
    skydrop: {
        num: 507,
        accuracy: 100,
    ...
    spotlight: {
        ...
        condition: { duration: 1, noCopy: true, onFoeRedirectTargetPriority: 2 },
        target: "normal",
        type: "Normal",
        zMove: {
            boost: { spd: 1 }
    ...
    springtidestorm: {
        ...
        target: "allAdjacentFoes",
        type: "Fairy",
        desc: "Has a 30% chance to lower the target's Attack by 1 stage. If the weather is Desolate Land or Sunny Day, this move does not check accuracy. If this move is used against a Pokemon holding Utility Umbrella, this move's accuracy remains at 80%.",
        shortDesc: "30% chance to lower the foe(s) Attack by 1. Sun: can't miss."
    },
    stealthrock: {
        num: 446,
        accuracy: true,
    ...
    stomp: {
        ...
        pp: 20,
        priority: 0,
        flags: { contact: 1, protect: 1, mirror: 1, nonsky: 1, metronome: 1, minimize: 1, striker: 1 },
        secondary: { chance: 30, volatileStatus: "flinch" },
        target: "normal",
        type: "Normal",
        contestType: "Tough",
    ...
    submission: {
        ...
        type: "Fighting",
        contestType: "Cool",
        desc: "Has a 20% to lower the target's Defense by 1 stage. Prevents the target from switching for four or five turns (seven turns if the user is holding Grip Claw). Causes damage to the target equal to 1/8 of its maximum HP (1/6 if the user is holding Binding Band), rounded down, at the end of each turn during effect. The target can still switch out if it is holding Shed Shell or uses Baton Pass, Flip Turn, Parting Shot, Shed Tail, Teleport, U-turn, or Volt Switch. The effect ends if either the user or the target leaves the field, or if the target uses Mortal Spin, Rapid Spin, or Substitute successfully. This effect is not stackable or reset by using this or another binding move.",
        shortDesc: "20% Def drop. Traps and damages the target for 4-5 turns."
    },
    substitute: {
        num: 164,
        accuracy: true,
    ...
    tailwind: {
        ...
        condition: { duration: 4, onSideResidualOrder: 26, onSideResidualSubOrder: 5 },
        target: "allySide",
        type: "Flying",
        zMove: { effect: "crit2" },
        contestType: "Cool",
    ...
    thunderouskick: {
        ...
        pp: 10,
        priority: 0,
        flags: { contact: 1, protect: 1, mirror: 1, striker: 1 },
        secondary: {
            chance: 100,
            boosts: { def: -1 }
        },
    ...
    tidebreaker: {
        ...
        type: "Water",
        contestType: "Beautiful",
        desc: "Has a 20% chance to lower the target's Defense by 1 stage. This move's type effectiveness against Water is changed to be super effective no matter what this move's type is.",
        shortDesc: "10% chance to lower Def by 1. Super effective on Water."
    },
    tidyup: {
        num: 882,
        accuracy: true,
    ...
    trickroom: {
        ...
        condition: { duration: 5, onFieldResidualOrder: 27, onFieldResidualSubOrder: 1 },
        target: "all",
        type: "Psychic",
        zMove: {
            boost: { accuracy: 1 }
    ...
    triplearrows: {
        ...
        pp: 10,
        priority: 0,
        flags: { protect: 1, mirror: 1, metronome: 1, striker: 1 },
        critRatio: 2,
        secondaries: [
            {
                chance: 50,
    ...
    twister: {
        ...
        type: "Dragon",
        contestType: "Cool",
        desc: "Power doubles if the target is using Bounce, Fly, or Sky Drop, or is under the effect of Sky Drop. Prevents the target from switching for four or five turns (seven turns if the user is holding Grip Claw). Causes damage to the target equal to 1/8 of its maximum HP (1/6 if the user is holding Binding Band), rounded down, at the end of each turn during effect. The target can still switch out if it is holding Shed Shell or uses Baton Pass, Flip Turn, Parting Shot, Shed Tail, Teleport, U- turn, or Volt Switch. The effect ends if either the user or the target leaves the field, or if the target uses Mortal Spin, Rapid Spin, or Substitute successfully. This effect is not stackable or reset by using this or another binding move.",
        shortDesc: "Traps and damages the target for 4-5 turns.",
    },
    upperhand: {
        num: 918,
    ...
    uproar: {
        ...
        condition: { duration: 3, onResidualOrder: 28, onResidualSubOrder: 1, onLockMove: "uproar" },
        target: "randomNormal",
        type: "Normal",
        contestType: "Cute",
    ...
    wildboltstorm: {
        ...
        target: "allAdjacentFoes",
        type: "Electric",
        desc: "Has a 30% chance to paralyze the target. If the weather is Primordial Sea or Rain Dance, this move does not check accuracy. If this move is used against a Pokemon holding Utility Umbrella, this move's accuracy remains at 80%.",
        shortDesc: "30% chance to paralyze foe(s). Rain: can't miss."
    },
    wildcharge: {
        num: 528,
        accuracy: 100,
        ...
        type: "Electric",
        contestType: "Tough",
        desc: "Has a 10% chance to paralyze the target. If the target lost HP, the user takes recoil damage equal to 1/3 the HP lost by the target, rounded half up, but not less than 1 HP.",
