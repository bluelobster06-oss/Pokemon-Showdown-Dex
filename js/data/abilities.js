exports.BattleAbilities = {
    ...
    anticipation: {
        ...
        shortDesc: "On switch-in, this Pokemon shudders and shields if any foe has a supereffective or OHKO move."
    },
    arenatrap: {
        flags: {},
        name: "Arena Trap",
    ...
    bigpecks: {
        ...
        rating: 0.5,
        num: 145,
        desc: "When this Pokemon has 1/3 or less of its maximum HP, rounded down, its offensive stat is multiplied by 1.5 while using a Flying-type attack.",
        shortDesc: "At 1/3 or less of its max HP, this Pokemon's offensive stat is 1.5x with Flying attacks."
    },
    blaze: {
        onModifyAtkPriority: 5,
        onModifySpAPriority: 5,
    ...
    effectspore: {
        ...
        rating: 2,
        num: 27,
        desc: "33% chance a Pokemon making contact with this Pokemon will be poisoned, paralyzed, or fall asleep.",
        shortDesc: "33% chance of poison/paralysis/sleep on others making contact with this Pokemon."
    },
    electricsurge: {
        flags: {},
        name: "Electric Surge",
    ...
    flareboost: {
        ...
        shortDesc: "While this Pokemon is burned, its attacks have 1.5x power."
    },
    flashfire: {
        ...
        rating: 3.5,
        num: 18,
        desc: "This Pokemon is immune to Fire-type moves. The first time it is hit by a Fire-type move, its offensive stat is multiplied by 1.5 while using a Fire-type attack as long as it remains active and has this Ability. If this Pokemon is frostbitten, it cannot be defrosted by Fire-type attacks.",
    ...
    flowerveil: {
        ...
        rating: 0,
        num: 166,
        desc: "Allies on this Pokemon's side cannot have their stat stages lowered by other Pokemon or have a non-volatile status condition inflicted on them by other Pokemon.",
        shortDesc: "Allies can't have stats lowered or status inflicted by other Pokemon."
    },
    fluffy: {
        flags: { breakable: 1 },
        name: "Fluffy",
    ...
    galewings: {
        ...
        rating: 1.5,
        num: 177,
        desc: "If this Pokemon has 1/2 or more of its maximum HP, its Flying-type moves have their priority increased by 1.",
        shortDesc: "If this Pokemon has 1/2 or more of its maximum HP, its Flying-type moves have their priority increased by 1."
    },
    galvanize: {
        onModifyTypePriority: -1,
        onBasePowerPriority: 23,
    ...
    grasspelt: {
        ...
        rating: 0.5,
        num: 179,
        desc: "If Grassy Terrain is active, this Pokemon's Defense and Special Defense is multiplied by 1.5.",
        shortDesc: "If Grassy Terrain is active, this Pokemon's Defense and Sp.Def is multiplied by 1.5."
    },
    grassysurge: {
        flags: {},
        name: "Grassy Surge",
    ...
    hydration: {
        ...
        rating: 2.5,
        num: 93,
        desc: "This Pokemon has its non-volatile status condition cured at the end of each turn if Rain Dance is active. This effect is prevented if this Pokemon is holding a Utility Umbrella. Mud Sport is set on the field on entry of the Pokemon with this Ability.",
        shortDesc: "Rain: Heals status conditions at the end of each turn. Mud Sport on entry."
    },
    hypercutter: {
        flags: { breakable: 1 },
        name: "Hyper Cutter",
    ...
    icebody: {
        ...
        rating: 1,
        num: 115,
        desc: "If Snow is active, this Pokemon restores 1/8 of its maximum HP, rounded down, at the end of each turn. If Snow is not active, the holder heals 1/16 of its maximum HP instead. This effect is prevented if this Pokemon is holding a Utility Umbrella.",
        shortDesc: "Snow: Heals 1/8 of its max HP each turn. Heals 1/16 max HP otherwise."
    },
    iceface: {
        onSwitchInPriority: -2,
        onDamagePriority: 1,
    ...
    illuminate: {
        ...
        rating: 2,
        num: 35,
        desc: "All moves on the field have their accuracy multiplied by 1.2.",
        shortDesc: "All moves on the field have their accuracy multiplied by 1.2."
    },
    illusion: {
        flags: { failroleplay: 1, noreceiver: 1, noentrain: 1, notrace: 1, failskillswap: 1 },
        name: "Illusion",
    ...
    innerfocus: {
        ...
        shortDesc: "This Pokemon cannot be made to flinch. Immune to Intimidate and Focus Punch losing focus."
    },
    insomnia: {
        flags: { breakable: 1 },
        name: "Insomnia",
    ...
    keeneye: {
        ...
        rating: 0.5,
        num: 51,
        desc: "Prevents other Pokemon from lowering this Pokemon's accuracy stat stage. This Pokemon ignores a target's evasiveness stat stage and the effects of Bright Powder, Lax Incense, Wonder Skin, Sand Veil and Snow Cloak.",
        shortDesc: "This Pokemon's accuracy can't be lowered by others; ignores their evasiveness multipliers."
    },
    klutz: {
        onSwitchInPriority: 1,
        flags: {},
    ...
    leafguard: {
        ...
        rating: 1.5,
        num: 102,
        desc: "This Pokemon has its non-volatile status condition cured at the end of each turn if Sunny Day is active. This effect is prevented if this Pokemon is holding a Utility Umbrella. Immune to critical hits.",
        shortDesc: "Sun: non-volatile status conditions cured at the end of each turn. Immune to critical hits."
    },
    levitate: {
        flags: { breakable: 1 },
        name: "Levitate",
    ...
    longreach: {
        ...
        rating: 1,
        num: 203,
        desc: "This Pokemon's contact attacks do not make contact with the target and get a 20% power boost.",
        shortDesc: "This Pokemon's contact attacks do not make contact with the target and get a 20% power boost."
    },
    magicbounce: {
        onTryHitPriority: 1,
        flags: { breakable: 1 },
    ...
    magmaarmor: {
        ...
        rating: 1,
        num: 40,
        desc: "This Pokemon cannot be affected by frostbite. Gaining this Ability while frostbitten cures it. Immune to critical hits.",
        shortDesc: "Immune to frostbite. Gaining this Ability while frostbitten cures it. Immune to critical hits."
    },
    magnetpull: {
        flags: {},
        name: "Magnet Pull",
    ...
    noguard: {
        ...
        rating: 4,
        num: 99,
        desc: "Every move used by or against this Pokemon will always hit. Immune to critical hits.",
        shortDesc: "Every move used by or against this Pokemon will always hit. Immune to critical hits."
    },
    normalize: {
        onModifyTypePriority: 1,
        onBasePowerPriority: 23,
    ...
    pickpocket: {
        ...
        rating: 1,
        num: 124,
        desc: " If this Pokemon has no item, it steals the item off a Pokemon it hits with an attack. This effect applies after all hits from a multi-hit move. This effect is prevented if the move had a secondary effect removed by the Sheer Force Ability.",
        shortDesc: "If this Pokemon has no item and lands a contact move, it steals the target's item."
    },
    pickup: {
        onResidualOrder: 28,
        onResidualSubOrder: 2,
    ...
    protosynthesis: {
        ...
        rating: 3,
        num: 281,
        desc: "If Sunny Day or Desolate Land is active or this Pokemon uses a held Booster Energy, this Pokemon's highest stat is multiplied by 1.3, or by 1.5 if the highest stat is Speed. Stat stage changes are considered at the time this Ability activates. If multiple stats are tied, Attack, Defense, Special Attack, Special Defense, and Speed are prioritized in that order. If this effect was started by Sunny Day, a held Booster Energy will not activate and the effect ends when Sunny Day is no longer active. If this effect was started by a held Booster Energy, it ends when this Pokemon is no longer active.",
        shortDesc: "Sunny Day/Desolate Land active or Booster Energy used: highest stat is 1.3x, or 1.5x if Speed."
    },
    psychicsurge: {
        flags: {},
        name: "Psychic Surge",
    ...
    quickfeet: {
        ...
        rating: 2.5,
        num: 95,
        desc: "If this Pokemon has a non-volatile status condition, its Speed is multiplied by 1.5. This Pokemon ignores the paralysis effect of halving Speed and the full paralysis chance.",
        shortDesc: "If this Pokemon is statused, its Speed is 1.5x; ignores Speed drop and paralysis chance from paralysis."
    },
    raindish: {
        flags: {},
        name: "Rain Dish",
        rating: 1.5,
        num: 44,
        desc: "If Rain is active, this Pokemon restores 1/8 of its maximum HP, rounded down, at the end of each turn. If Rain is not active, the holder heals 1/16 of its maximum HP instead. This effect is prevented if this Pokemon is holding a Utility Umbrella.",
        shortDesc: "Rain: Heals 1/8 of its max HP each turn. Heals 1/16 max HP otherwise."
    },
    rattled: {
        flags: {},
        name: "Rattled",
    ...
    runaway: {
        ...
        rating: 2.5,
        num: 50,
        desc: "This Pokemon can always flee from wild Pokemon battles, regardless of its Speed or the opposing Pokemon's abilities. Immune to being trapped by the effects of the abilities Shadow Tag, Arena Trap, Magnet Pull, the moves Mean Look, Block, Spider Web, Ingrain and the secondary effects of all partial trapping moves.",
        shortDesc: "This Pokemon can always flee from wild Pokemon battles. Immune to trapping effects."
    },
    sandforce: {
        onBasePowerPriority: 21,
        flags: {},
    ...
    tangledfeet: {
        ...
        shortDesc: "When switching in, this Pokemon is immune to entry hazards on its side of the field."
    },
    tanglinghair: {
        flags: {},
        name: "Tangling Hair",
    ...
    wonderskin: {
        ...
        rating: 2,
        num: 147,
        desc: "Non-damaging moves that check accuracy have their accuracy changed to 50% when used against this Pokemon. This effect comes before other effects that modify accuracy. Cannot be affected by any status conditions and Rest fails when used by this Pokemon.",
        shortDesc: "Status moves with accuracy checks are 50% against this Pokemon. Status condition immunity."
    },
    zenmode: {
        onResidualOrder: 29,
        condition: {},
